...
#else
#define BOOTSCREEN_PATH "/mnt/SDCARD/.tmp_update/res/bootScreen.png"
#endif
...
int main(void) {
    ...
    font40_outline = TTF_OpenFont("ressources/Exo-2-Bold-Italic.ttf", 40);
    ...
    while (running) {
        ...
        while (SDL_PollEvent(&event)) {
            ...
            if (levelPage == 1) {
                ...
                surfaceBSS = IMG_Load("ressources/confirm.png");
                SDL_BlitSurface(surfaceBSS, NULL, screen, NULL);
                SDL_FreeSurface(surfaceBSS);
            }
